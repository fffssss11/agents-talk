...
- Python 标准库运行时不随源码包捆绑。Node.js、Playwright 与浏览器仅用于开发测试或宣传素材渲染，适用各自的许可证。Playwright 锁定版本见 `package-lock.json`，上游为 [microsoft/playwright](https://github.com/microsoft/playwright)。
